...
export default function TermsScreen() {
  ...
  const legalDocuments = [
    {
      ...
      description: 'The agreement between you and VaultBank governing your use of our services.',
    },
    {
      id: 'privacy',
      icon: Eye,
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
      ...
      >
        {/* Security Banner */}
        <View style={[styles.securityBanner, { backgroundColor: colors.primary + '15' }]}>
          <View style={[styles.securityIcon, { backgroundColor: colors.primary + '30' }]}>
        ...
        <View style={[styles.documentsCard, { backgroundColor: colors.surface }]}>
          {legalDocuments.map((doc, index) => (
            <TouchableOpacity 
              key={doc.id}
              style={[
                styles.documentItem,
                index < legalDocuments.length - 1 && { borderBottomWidth: 1, borderBottomColor: colors.border }
              ]}
              activeOpacity={0.7}
            >
              <View style={[styles.documentIcon, { backgroundColor: colors.surfaceHighlight }]}>
              ...
              <View style={styles.documentContent}>
                ...
                <Text style={[styles.documentSubtitle, { color: colors.textMuted }]}>
                  {doc.subtitle}
                </Text>
              </View>
